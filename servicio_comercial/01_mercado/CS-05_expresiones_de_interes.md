# CS-05 — Formulario de expresión de interés

**Propietario:** Profesional de proyectos
**Última revisión:** 2026-07-14 (se agregaron la pregunta sobre el certificado de calibración, la caducidad de la respuesta, el idioma preferido y el texto de consentimiento para la protección de datos)
...
| Caducidad de la respuesta | [POR DILIGENCIAR — por ejemplo, 60 días desde el envío; respuestas obsoletas eliminadas de CS-10] |
| Almacenamiento | [POR DILIGENCIAR — por ejemplo, CRM comercial, backend de formulario seguro] |
...
|---|---|---|---|
| 1 | Nombre de la organización | Texto | Identificar al cliente potencial |
| 2 | Nombre de contacto y correo electrónico | Texto | Seguimiento comercial |
| 3 | País/ciudad | Texto | Logística y huso horario |
| 4 | Gases deseados | Selección múltiple: CO, SO₂, NO, NO₂, O₃ | Validación del alcance |
...
| 10 | Periodo preferido | Intervalo de fechas / trimestre | Planificación del calendario |
...
- El tratamiento de datos hace referencia a los controles de confidencialidad existentes (`P-PSEA-19`, código vigente tras la renumeración del 2026-06-14; ver `00_control/equivalencia_codigos_sgc.md`).
- Las respuestas alimentan el rastreador CS-10 como etapa "Interés" del canal de oportunidades.
