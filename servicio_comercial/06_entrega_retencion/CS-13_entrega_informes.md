...
Completar la entrega al cliente de manera consistente. El SGC ya controla el informe técnico a través de `P-PSEA-09` y `F-PSEA-13`. La capa comercial solo necesita un mensaje de entrega controlada y, si aún no está cubierto, una declaración de participación.
...
| Campo | Valor |
|---|---|
| Código de participante y ronda | [POR DILIGENCIAR] |
| Identificador/versión del informe adjunto | [POR DILIGENCIAR] |
| Aviso de confidencialidad | [POR DILIGENCIAR — texto estándar: "Este informe es confidencial y está destinado únicamente al participante designado. La distribución a terceros requiere autorización por escrito de CALAIRE-EA."] |
| Estado del informe | FINAL |
| Plazo de apelación | [POR DILIGENCIAR — 14 días calendario desde la emisión final según P-PSEA-18] |
| Instrucciones de acceso seguro o entrega | [POR DILIGENCIAR] |
| Recordatorio de uso de informes | **Texto estándar: NO lo modifique sin la aprobación CS-01. Ver bloque abajo.** |
| Contactos comerciales y técnicos | [POR DILIGENCIAR] |
...
1. La Directora del grupo verifica la dirección de correo electrónico con los registros CS-07 y CS-11.
