...
**Estado:** 0,3 — decisiones de propuesta aprobadas; puertas de liberación pendientes
**Propietario:** Gerente de servicio
**Próxima reseña:** al completar costos, validación técnica y revisión jurídica
**Última revisión:** 2026-07-14 (entrevista decisión institucional y aprobación de propuesta)
**QMS code reference:** ver `00_control/equivalencia_codigos_sgc.md` para mapeo de códigos PSEA / F-PSEA / I-PSEA / DG-PSEA tras la renumeración del 2026-06-14.
...
| Propietario del servicio/gerente del servicio | Carmen Elena Zapata | Coordinadora EA; confirmación institucional del 2026-07-14 |
| Líder comercial | David Pulgarín | Profesional de Proyectos; confirmación institucional del 2026-07-14 |
| Coordinador de ronda | Carmen Elena Zapata | Coordinadora EA; confirmación institucional del 2026-07-14 |
| Propietario de Calidad / SGC | Jeniffer Ochoa | Profesional de Gestión de Calidad; confirmación institucional del 2026-07-14 |
...
| Validez de la cotización | 30 días calendario desde su emisión, sin exceder la fecha límite de inscripción ni quedará vigente dentro de los 15 días anteriores al inicio de la ronda | decisión institucional del 2026-07-14; ver CS-06 sección 1 |
...
Provisión anual aprobada a recuperar mediante cuotas redondas:
...
El **round-use factor** (fracción del año de uso intensivo del equipo atribuible a un round típico) debe documentarse en CS-04 Tab 4 columna "Round-use factor" con su evidencia (historial de uso, campañas anteriores, plan de mantenimiento). Sin este factor la asignación por ronda no se puede calcular.
...
| Hardware / almacenamiento | Menos reguladores/conexiones | Más reguladores, almacenamiento, manipulación | La configuración existente favorece la mezcla si es técnicamente adecuada |
...
| Costo estimado por ronda (COP / EUR) | [RELLENO — de CS-04 Pestaña 5] | [RELLENO] | [RELLENO] |
...
**Aprobador técnico:** Carmen Elena Zapata, con concepto técnico de Wilson Salas
...
| Inscripción mínima (umbral de ingresos) | Pendiente de CS-04. Antes de publicar una ronda pagada, la Universidad debe decidir expresamente si ejecuta cuando el ingreso confirmado no cubre el costo directo. | análisis de viabilidad CS-04 |
...
|---|---|---|---|
| Baja de participantes ≥ 30 días calendario antes del inicio de la ronda | El participante puede solicitar una única reprogramación, sujetar una capacidad o cancelar. | Si cancela, la devolución de lo pagado menos únicamente costos directos no recuperables, ya incurridos, documentados y permitidos por las políticas de la Universidad. Sin penalidad porcentual genérica. | CS-12 |
...
|---|---|---|---|
| 0.1 BORRADOR | [RELLENO] | [RELLENO] | Borrador inicial del modelo MVP |
| 0.2 BORRADOR | 2026-07-14 | [RELLENO] | Se agregó orientación sobre evidencia, idioma de trabajo, tipo de cambio, estructura de lista de tarifas, marcador de posición de alcance de fuerza mayor. |
| 0.3 PROPUESTA APROBADA | 2026-07-14 | Carmen Elena Zapata | Decisiones sobre propuestas comerciales congeladas; Las puertas de liberación financiera, legal y técnica siguen pendientes. |
| 0.3.1 CORRECCIÓN EDITORIAL | 2026-07-14 | [RELLENO] | Bloque estándar "Informe de uso" (§9) unificado con CS-08 cláusula 16 y CS-13; correcciones de terminología ("cupo", "verificación", "Líder comercial"). Sin cambio de decisiones. |
...
## Anexo — Guía de evidencias para cada marcador [RELLENO]

Para que un implementador (o un agente de IA) que tome esta tarea pueda completar cada `[RELLENO]` sin ambigüedad, esta tabla indica qué documento o decisión hace falta para cada sección:

| Sección | Marcador [RELLENO] | Documento o decisión de origen |
|---|---|---|
| 1 | Nombre del servicio | propuesta aprobada, nombramiento del SGC |
| 1 | Provider legal identity | registro mercantil, NIT |
| 1 | Roles (gerente de servicios, comercial, coordinador, SGC) | organigrama, decreto de creación |
