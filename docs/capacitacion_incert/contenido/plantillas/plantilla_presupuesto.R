...
#   u_c = sqrt(sum(u_i^2)),  varianza %, ranking
...
#
# Casos precargados:
#   1) Analizador O3 a 120 nmol/mol, presupuesto Tipo B con specs de
...
# ---------------------------------------------------------------------------
# CASO 1 — Analizador O3 a 120 nmol/mol (Tipo B, specs de fabricante, M4)
# Specs estilo Thermo 49i Table 1-1: ruido 0.25 ppb RMS (u directa),
