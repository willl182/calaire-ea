...
- Estructura horaria (462 min obligatorios) no admite práctica: se añade **práctica de laboratorio complementaria (6–8 h)**. M7 conserva su entregable evaluado del curso; E15 es un entregable adicional de la práctica con el presupuesto del equipo propio, y el caso KRISS sirve como validación externa/contraste.
...
### P1 — jornada mínima viable de la práctica (~8 h)
