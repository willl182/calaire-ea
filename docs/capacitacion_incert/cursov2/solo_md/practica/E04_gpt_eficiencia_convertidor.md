...
Generar NO₂ por titulación en fase gaseosa, estimar la eficiencia `η` del convertidor en cinco niveles, evaluar linealidad y repetibilidad entre dos sesiones realizadas en días distintos (duración experimental: 2 días), y eliminar el defecto de titulación profunda del diseño anterior.
...
### Sesión 2, aproximadamente 100 min

Repetir preparación, cero y NO base; aplicar orden descendente 160, 120, 80, 40 nmol/mol; repetir nivel 80 y cero final; analizar pendientes por sesión y pendiente combinada con efecto entre días.

**Nota logística:** ver `P0_agenda_dia2.md` — la sesión 2 de E04 se agenda como continuación fuera de la jornada principal si el curso no dispone de una segunda sesión.
...
es decir `η=0.970±0.010 (k=2)`. Si la sesión 2 entrega 0.966, la diferencia entre sesiones es 0.004, menor que `√(0.005²+0.005²)=0.0071`: sin cambio significativo detectado.
...
- Diferencia de pendientes entre sesiones compatible con sus incertidumbres; si no, incluir precisión intermedia o declarar inestabilidad.
