...
## 1.1 Mensurando y resultado de medición {#gum-mensurando-resultado}
...
## 1.2 Modelo de medición {#gum-modelo-medicion}
...
## 1.3 Error e incertidumbre no son sinónimos {#gum-error-vs-incertidumbre}
...
## 1.4 Incertidumbre estándar, combinada y expandida {#gum-tipos-incertidumbre}
...
## 1.5 Trazabilidad metrológica {#gum-trazabilidad-metrologica}
