...
## 3.1 De la información disponible a una distribución {#gum-info-a-distribucion}
...
## 3.2 Distribución rectangular {#gum-pdf-rectangular}
...
## 3.3 Distribución normal {#gum-pdf-normal}
...
## 3.4 Distribución triangular {#gum-pdf-triangular}
...
## 3.6 Distribución arcoseno o en U {#gum-pdf-arcoseno}
...
## 3.7 Trapecio curvilíneo para límites inexactos {#gum-pdf-trapecio}
...
## 3.8 Ejemplo Tipo B con especificación genérica {#gum-ejemplo-tipo-b}
