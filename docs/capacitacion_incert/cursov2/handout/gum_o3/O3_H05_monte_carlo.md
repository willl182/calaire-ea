# 5. Propagación mediante método de Monte Carlo {#gum-mcm}

## 5.1 Cuándo usar MCM {#gum-mcm-cuando-usar}
...
## 5.2 Procedimiento general {#gum-mcm-procedimiento}
...
## 5.3 Muestreo de PDFs {#gum-mcm-muestreo-pdfs}
...
## 5.4 Procedimiento adaptativo {#gum-mcm-adaptativo}
...
## 5.5 Intervalos de cobertura {#gum-mcm-intervalos-cobertura}
