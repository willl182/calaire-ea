...
Generar NO₂ por titulación en fase gaseosa, estimar eficiencia \(\eta\) del convertidor en cinco niveles, evaluar linealidad y repetibilidad entre dos sesiones realizadas en días distintos (duración experimental: 2 días), y eliminar defecto de titulación profunda del diseño anterior.
...
5. Analizar pendientes por sesión y pendiente combinada con efecto entre días.
...
o \(\eta=0.970\pm0.010\), \(k=2\). Si la sesión 2 entrega 0.966, diferencia entre sesiones es 0.004, menor que \(\sqrt{0.005^2+0.005^2}=0.0071\), por lo que no se detecta cambio significativo al nivel de una incertidumbre estándar combinada.
