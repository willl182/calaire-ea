...
Enlaza con **M4**: es el experimento concreto del plan de reemplazo para deriva. **Debe iniciarse ≥7 días antes de la práctica de laboratorio complementaria** (ver `P0_agenda_dia2.md`). Alimenta la deriva de **E15**.
