...
**Documentos asignados:** `P-PSEA-12`, `P-PSEA-13`, `P-PSEA-23`, `DG-PSEA-02`, `DG-PSEA-03`  
...
- **Relacion critica:** `P-PSEA-13` (matriz de evidencias), `P-PSEA-23` (flujo de datos).

### 2. `P-PSEA-13` — Matriz de registros y evidencias del PEA
- **Tipo:** Procedimiento / Matriz
- **Clase:** Ficha activa
- **Prioridad:** Alta
...
- **Relacion critica:** `P-PSEA-12`, todos los `F-PSEA` vigentes.

### 3. `P-PSEA-23` — Flujo tecnico de datos digitales del PEA
- **Tipo:** Procedimiento
- **Clase:** Ficha activa
- **Prioridad:** Alta
...
- **Relacion critica:** `DG-PSEA-02`, `DG-PSEA-03`, `I-PSEA-17`, `I-PSEA-18`, `F-PSEA-09`, `F-PSEA-10`, `F-PSEA-12`, `F-PSEA-13A-D`, `F-PSEA-14`, `F-PSEA-04`.
...
- **Riesgo clave:** No es un formato `F-PSEA`; no confundir con `F-PSEA-07`, `F-PSEA-12` o `F-PSEA-09`.
- **Relacion critica:** `I-PSEA-10`, `I-PSEA-16`, todos los formatos de `calaire-app`.
...
- **Riesgo clave:** No es un formato `F-PSEA`; no confundir con `F-PSEA-10` ni `F-PSEA-14`.
- **Relacion critica:** `I-PSEA-17`, `I-PSEA-18`, `F-PSEA-10`, `F-PSEA-13A-D`, `F-PSEA-14`, `F-PSEA-04`.

---

## Reglas especificas para este paquete

1. **Diferencia clave:** `P-PSEA-12` lista documentos; `P-PSEA-13` lista evidencias/registros; `P-PSEA-23` mapea flujo de datos.
...
3. **Archivos tecnicos internos:** Listar en `P-PSEA-23` solo como insumos, no como formatos oficiales.
