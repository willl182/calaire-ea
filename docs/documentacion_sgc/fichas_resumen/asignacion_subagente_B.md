...
**Documentos asignados:** `I-PSEA-10`, `I-PSEA-16`, `I-PSEA-17`, `I-PSEA-18`, `F-PSEA-07`, `F-PSEA-10`, `F-PSEA-13A`, `F-PSEA-13B`, `F-PSEA-13C`, `F-PSEA-13D`, `F-PSEA-14`  
...
#### `I-PSEA-10` — Uso de `calaire-app` por participante
- **Tipo:** Instructivo
- **Clase:** Ficha activa
...
- **Riesgo clave:** No reemplaza `P-PSEA-20` ni define criterios tecnicos; solo explica uso operativo del aplicativo.
- **Salidas:** `F-PSEA-05`, `F-PSEA-05A`, `F-PSEA-09`, exportacion posterior `F-PSEA-12`.
...
- **Riesgo clave:** No reemplaza `P-PSEA-09`; solo documenta la operacion del aplicativo.
- **Salidas:** `F-PSEA-01`, `F-PSEA-02`, `F-PSEA-07`, `F-PSEA-12`, `F-PSEA-16` si aplica.

#### `I-PSEA-17` — Uso del preprocesador de `pt_app`
- **Tipo:** Instructivo
- **Clase:** Ficha activa
- **Prioridad:** Alta
- **Proposito:** Explicar operativamente como ejecutar preprocesamiento y registrar salidas.
- **Riesgo clave:** No reemplaza `P-PSEA-06` (diseno estadistico); solo explica uso del aplicativo.
- **Salidas:** `F-PSEA-10`, `F-PSEA-13A`, `F-PSEA-13B`, `F-PSEA-14`.
...
- **Riesgo clave:** No reemplaza `P-PSEA-06`; solo explica uso del aplicativo.
- **Salidas:** `F-PSEA-13C`, `F-PSEA-13D`, `F-PSEA-14`, `F-PSEA-04`.

### Formatos criticos

#### `F-PSEA-07` — Ficha digital de ronda EA
...
- **Riesgo clave:** No es el plan de ronda (`F-PSEA-06`); es insumo de el.
- **Entrada:** `calaire-app`.
- **Salida:** `F-PSEA-06`.
...
- **Entrada:** `F-PSEA-12`, `F-PSEA-05A`.
- **Salida:** `F-PSEA-13A`, `F-PSEA-13B`, `F-PSEA-14`.
...
- **Riesgo clave:** No confundir con `F-PSEA-13C` (resultados de homogeneidad).
...
- **Riesgo clave:** No confundir con `F-PSEA-13D` (resultados de estabilidad).

#### `F-PSEA-13C` — Resultados de homogeneidad
- **Tipo:** Formato / Subformato
- **Clase:** Ficha activa
- **Prioridad:** Alta
- **Proposito:** Resultado de homogeneidad exportado desde `pt_app`.
- **Riesgo clave:** No confundir con `F-PSEA-13A` (datos preprocesados).

#### `F-PSEA-13D` — Resultados de estabilidad
- **Tipo:** Formato / Subformato
- **Clase:** Ficha activa
- **Prioridad:** Alta
- **Proposito:** Resultado de estabilidad exportado desde `pt_app`.
- **Riesgo clave:** No confundir con `F-PSEA-13B` (datos preprocesados).

#### `F-PSEA-14` — Datos oficiales consolidados para evaluacion de aptitud
...
- **Riesgo clave:** No es `F-PSEA-12` (exportacion desde `calaire-app`). Es el dataset consolidado final.
- **Entrada:** `F-PSEA-12`, `F-PSEA-05A`, preprocesador.
- **Salida:** Modulo de analisis `pt_app`, `F-PSEA-04`.

---

## Reglas especificas para este paquete

1. **Instructivos vs. Procedimientos:** `I-PSEA-17` e `I-PSEA-18` explican "como usar el boton"; `P-PSEA-06` explica "que significa el resultado y como se calcula".
2. **Cadena H/E:** `F-PSEA-13A` -> `F-PSEA-13C` (homogeneidad); `F-PSEA-13B` -> `F-PSEA-13D` (estabilidad).
3. **`F-PSEA-14` es el dataset oficial:** Diferenciar explicitamente de `F-PSEA-12` y de archivos tecnicos intermedios.
