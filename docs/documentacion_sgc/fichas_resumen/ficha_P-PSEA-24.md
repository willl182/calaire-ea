...
| `F-PSEA-16` | Registro/caso de queja | Referencia |
...
|---|---|---|
| `P-PSEA-16` | Si la queja deriva en NC/CAPA | Obligatorio |
| `P-PSEA-20` | Comunicaciones que registran la queja | Obligatorio |
| `F-PSEA-16` | Registro de caso de queja | Obligatorio |
| `P-PSEA-23` | Flujo de datos que puede afectarse | Referencia |
...
- No es un procedimiento de apelaciones (eso es `P-PSEA-25`); las quejas son diferentes.
- No es un procedimiento de colusion (eso es `P-PSEA-08`); conecta con el si la queja lo involucra.
...
- **Confundir con apelaciones:** Las quejas (`P-PSEA-24`) se gestionan en `calaire-app`; las apelaciones (`P-PSEA-25`) van por correo formal.
- **Omitir conexion con P-PSEA-16:** Debe indicar claramente cuando una queja deriva en NC/CAPA.
...
El procedimiento define recepcion, registro como caso SGC en `calaire-app`, evaluacion, respuesta, seguimiento y conexion con `P-PSEA-16`, `P-PSEA-20` y `F-PSEA-16`, diferenciando claramente quejas de apelaciones.
