...
|---|---|---|
| `F-PSEA-12` | Datos de participantes exportados desde `calaire-app` | Insumo |
| `F-PSEA-05A` | Anexo tecnico de equipos e instrumentos | Insumo |
...
- No reemplaza `P-PSEA-23` (flujo tecnico); complementa la parte operativa del preprocesador.
...
- **Describir analisis estadistico:** El analisis PT propiamente dicho se cubre en `I-PSEA-18`.
