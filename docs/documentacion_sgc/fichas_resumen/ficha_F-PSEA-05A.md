...
| `F-PSEA-14` | Dataset consolidado (incluye equipos) | Referencia |
...
|---|---|---|
| `F-PSEA-05` | Registro de participacion al que pertenece | Obligatorio |
| `F-PSEA-12` | Datos exportados que incluyen equipos | Obligatorio |
| `F-PSEA-14` | Dataset consolidado que incluye equipos | Obligatorio |
...
- No es el registro de participacion (eso es `F-PSEA-05`); es el anexo de equipos.
- No contiene datos de concentracion (eso es `F-PSEA-09`).
- No es un instructivo de uso.

#### Riesgos de interpretacion

- **Confundir con F-PSEA-05:** `F-PSEA-05` es el registro de participacion; `F-PSEA-05A` es el anexo tecnico de equipos.
...
El anexo tecnico de equipos contiene identificacion de equipos e instrumentos por participante, vinculado con `F-PSEA-05`, exportable desde `calaire-app` y consumible por `pt_app`, sin duplicar datos de concentracion ni de participacion.
