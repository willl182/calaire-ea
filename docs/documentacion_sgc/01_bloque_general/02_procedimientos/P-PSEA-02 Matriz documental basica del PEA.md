...
| `P-PSEA-14` | Colusion y falsificacion | P | Procedimiento de gestion | Elaborado | `01_bloque_general/06_procedimientos_gestion/P-PSEA-14 Colusion y falsificacion.md` |
| `P-PSEA-15` | Trabajo no conforme, no conformidades y acciones correctivas | P | Procedimiento de gestion | Elaborado | `01_bloque_general/06_procedimientos_gestion/P-PSEA-15 Trabajo no conforme no conformidades y acciones correctivas.md` |
| `P-PSEA-16` | Divulgacion y control de valores sensibles | P | Procedimiento de gestion | Elaborado | `01_bloque_general/06_procedimientos_gestion/P-PSEA-16 Divulgacion y control de valores sensibles.md` |
| `P-PSEA-17` | Quejas del PEA | P | Procedimiento de gestion | Elaborado | `01_bloque_general/06_procedimientos_gestion/P-PSEA-17 Quejas del PEA.md` |
| `P-PSEA-18` | Apelaciones del PEA | P | Procedimiento de gestion | Elaborado | `01_bloque_general/06_procedimientos_gestion/P-PSEA-18 Apelaciones del PEA.md` |
| `P-PSEA-19` | Confidencialidad operativa interna del PEA | P | Procedimiento de gestion | Elaborado | `01_bloque_general/06_procedimientos_gestion/P-PSEA-19 Confidencialidad operativa interna del PEA.md` |
| `P-PSEA-20` | Competencia y autorizacion operativa del PEA | P | Procedimiento de gestion | Elaborado | `01_bloque_general/06_procedimientos_gestion/P-PSEA-20 Competencia y autorizacion operativa del PEA.md` |
| `P-PSEA-21` | Proveedores criticos del PEA | P | Procedimiento de gestion | Elaborado | `01_bloque_general/06_procedimientos_gestion/P-PSEA-21 Proveedores criticos del PEA.md` |
| `P-PSEA-23` | Mejora continua del PEA | P | Procedimiento de gestion | Reservado / placeholder | `01_bloque_general/06_procedimientos_gestion/P-PSEA-23 Mejora continua del PEA.md` |
...
| `F-PSEA-07` | Preparacion y control del item | F | Registro de ronda | Activo operativo | `02_prueba_piloto_rondas/*/F-PSEA-07 Preparacion y control del item.md` |
| `F-PSEA-08` | Datos reportados por participante | F | Registro de ronda | Activo operativo | `02_prueba_piloto_rondas/*/F-PSEA-08 Datos reportados por participante.md` |
| `F-PSEA-09` | Datos de participantes exportados para analisis PT | F | Registro / exportacion | Activo operativo | `02_prueba_piloto_rondas/*/F-PSEA-09 Datos de participantes exportados para analisis PT.md` |
| `F-PSEA-10` | Registro de preprocesamiento de datos | F | Registro | Activo operativo | `02_prueba_piloto_rondas/*/F-PSEA-10 Registro de preprocesamiento de datos.md` |
| `F-PSEA-11` | Homogeneidad y estabilidad del item | F | Registro principal H/E | Activo operativo | `02_prueba_piloto_rondas/*/F-PSEA-11 Homogeneidad y estabilidad del item.md` |
...
| `F-PSEA-12` | Datos oficiales consolidados para evaluacion de aptitud | F | Dataset oficial / registro | Activo operativo | `02_prueba_piloto_rondas/*/F-PSEA-12 Datos oficiales consolidados para evaluacion de aptitud.md` |
| `F-PSEA-13` | Informe final de resultados | F | Informe / registro oficial | Activo operativo | `02_prueba_piloto_rondas/*/F-PSEA-13 Informe final de resultados.md` |
